         ...
         <table style="table-layout:auto">
            ...
            <tr>
               ...
               <td>
                  擁有設定檔的實體。<br/><br/>
                  可能的值包括：<ul>
                    <li><b>mvpd （例如Spectrum、Cablevision等）</b><br/>建立設定檔的原因為：基本驗證、使用平台身分的單一登入，或使用服務權杖的單一登入。</li>
...
### &#x200B;2. 擷取透過基本驗證或使用服務權杖方法的單一登入取得的特定mvpd的設定檔
...
### &#x200B;3. 擷取透過基本驗證或使用Platform Identity方法的單一登入取得的特定mvpd的設定檔
