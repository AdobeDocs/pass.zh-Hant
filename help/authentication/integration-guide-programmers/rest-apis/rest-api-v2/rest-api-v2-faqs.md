...
如果您正在處理需要整合REST API V2的應用程式，無論是新應用程式或從[REST API V1](#migration-rest-api-v1-to-rest-api-v2)或[SDK](#migration-sdk-to-rest-api-v2)移轉的現有應用程式，請由此章節開始。
...
如果使用者選取的MVPD沒有與指定的[服務提供者](rest-api-v2-glossary.md#service-provider)的有效整合，使用者端應用程式將會從Adobe Pass Authentication REST API V2收到[錯誤](/help/authentication/integration-guide-programmers/features-standard/error-reporting/enhanced-error-codes.md)。
...
如果使用者選取的MVPD不再與指定的[服務提供者](rest-api-v2-glossary.md#service-provider)有效整合，使用者端應用程式將會從Adobe Pass Authentication REST API V2收到[錯誤](/help/authentication/integration-guide-programmers/features-standard/error-reporting/enhanced-error-codes.md)。
