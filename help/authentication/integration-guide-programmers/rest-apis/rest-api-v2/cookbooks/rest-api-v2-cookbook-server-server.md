...
若要取得存取Token，程式設計師服務可以代表串流應用程式執行，而且必須遵循[動態使用者端註冊](../../rest-api-dcr/apis/dynamic-client-registration-apis-retrieve-access-token.md)檔案中所述的步驟。
...
* [REST API V2參考](/help/authentication/integration-guide-programmers/rest-apis/rest-api-v2/rest-api-v2-overview.md)
