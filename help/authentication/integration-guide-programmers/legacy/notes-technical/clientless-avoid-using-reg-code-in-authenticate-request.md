...
要求者\_id將解譯為univision®\_code=EKAFMFI，因為沒有「&amp;」，且Adobe找不到可與Token建立關聯的`regCode`引數。  完全有可能不會建立AuthN權杖，在這種情況下`/checkauthn`呼叫將找不到任何權杖。
...
1. 如果AuthN權杖建立失敗，Adobe可能會推出新功能，將錯誤代碼傳回第2個畫面以回應驗證呼叫。
