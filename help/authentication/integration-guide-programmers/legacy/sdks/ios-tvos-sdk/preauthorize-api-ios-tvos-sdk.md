...
>[!IMPORTANT]
>
>透過增強錯誤報告功能的媒體擷取的可能其他錯誤清單記錄在[進階錯誤報告](/help/authentication/integration-guide-programmers/features-standard/error-reporting/enhanced-error-codes.md)。
...
一或多個資源具有遭拒絕的預先授權決定，且Adobe Pass驗證設定中未啟用增強錯誤報告功能
...
一或多個資源具有遭拒絕的預先授權決定，且Adobe Pass驗證設定中已啟用增強錯誤報告功能
...
Adobe Pass驗證服務在服務預先授權API要求時發生錯誤
