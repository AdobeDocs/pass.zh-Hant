...
| 額外的引數 | 呼叫也可能包含啟用其他功能的選用引數，例如：</br></br>* generic_data — 可啟用[促銷臨時傳遞](/help/premium-workflow/temporary-access/temp-pass-feature.md#promotional-temp-pass)</br></br>範例： `generic_data=("email":"email@domain.com")` |
