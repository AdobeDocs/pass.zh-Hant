...
* **OAuth通訊協定：**
   * 如需啟用HBA的資訊，請參閱 [Adobe Pass TVE控制面板使用手冊](/help/authentication/tve-dashboard-user-guide.md)
...
* [Adobe Pass TVE控制面板使用手冊](/help/authentication/tve-dashboard-user-guide.md)
