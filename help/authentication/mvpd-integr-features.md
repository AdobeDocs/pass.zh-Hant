...
| 1.2 | [以通道為基礎的授權](/help/authentication/authz-usecase.md) | 一旦通過驗證，授權(AuthZ)可以在背景發生，並且只將網路通道識別碼和使用者識別碼傳遞給MVPD。 | A+ |                                                                                                                                                         |
...
| 1.8 | [多重通道授權](/help/authentication/mvpd-preflight-authz.md#preflight-multich-authz) | MVPD支援程式設計師在單一授權要求中傳送多個通道。 | B+ |                                                                                                                                                         |
