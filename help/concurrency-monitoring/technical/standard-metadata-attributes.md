...
Concurrency Monitoring API強制使用者端傳送下列值做為任何有效初始化呼叫的一部分： [工作階段起始呼叫](/help/concurrency-monitoring/technical/restrict-concurr-usage-mult-apps.md#api-calls-descr)。
...
透過[API v2.0](https://streams-stage.adobeprimetime.com/swagger-ui/index.html)，如果定義的原則需要這些屬性中的任何一個，則沒有該屬性的工作階段初始化嘗試將導致400錯誤請求。
